      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
          <li>
            <nuxt-link to="/">
              <div
                class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-sky-300 md:p-0 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
          ...
          <li>
            <button
              ...
              class="flex items-center justify-between w-full py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-sky-300 md:p-0 md:w-auto dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              :class="scrolled ? 'text-white dark:text-white' : 'text-white'"
            >
              PROFIL
