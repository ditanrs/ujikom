    ...
    <section class="py-16 px-4 bg-blue-700">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12 mt-10">
          <h2 class="text-3xl font-bold text-white mb-2">Ekstrakurikuler</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-6 px-56">
          <div v-for="(ekskul, i) in eskul" :key="i" class="bg-white bg-opacity-20 rounded-lg shadow-sm overflow-hidden transition-all duration-300 hover:bg-blue-500 hover:shadow-md">
            <div class="flex flex-col sm:flex-row h-48">
              <div class="sm:w-1/3 flex-shrink-0">
                <img :src="ekskul.foto" alt="foto" class="w-40 h-full object-fil" />
              </div>
              <div class="p-4 sm:w-2/3 flex items-center">
                <h3 class="text-2xl font-semibold text-white line-clamp-3">{{ ekskul.ket }}</h3>
              </div>
            </div>
          </div>
        </div>
