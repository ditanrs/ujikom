    ...
    <section class="py-16 px-4 bg-blue-700">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12 mt-10">
          <h2 class="text-3xl font-bold text-white mb-2">Galeri</h2>
        ...
        <div class="bg-white p-6 rounded-lg">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div v-for="(foto, i) in galeri" :key="i" class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
